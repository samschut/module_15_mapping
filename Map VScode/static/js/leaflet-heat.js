/*
 (c) 2014, Vladimir Agafonkin---- I changed some of the colors around for how I wanted it
...
!(function() {
  ...
  function t(i) {
    ...
    defaultGradient: { 0.4: "navy", 0.6: "dodgerblue", 0.7: "limegreen", 0.8: "orange", 1: "crimson" },
    data: function(t, i) {
    ...
    radius: function(t, i) {
      i = i || 30; var a = this._circle = document.createElement("canvas"),
        s = a.getContext("2d"),
